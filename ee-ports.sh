...
## https://docs.mirantis.com/docker-enterprise/v2.1/dockeree-products/ucp/admin/install-ucp.html#ucp-system-requirements
## https://docs.mirantis.com/docker-enterprise/v3.0/dockeree-products/mke/admin/install-mke.html#mke-system-requirements
## https://docs.mirantis.com/docker-enterprise/v3.1/dockeree-products/mke/install-mke.html#ports-used
